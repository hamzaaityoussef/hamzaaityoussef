...
- 🚀 [**Amazon Reviews Realtime Analysis**](https://github.com/hamzaaityoussef/amazon-reviews-realtime-analysis) – Real-time data processing with Kafka, Spark, MongoDB.
- 🔧 [**Django Load Balancing**](https://github.com/hamzaaityoussef/django-load-balancing-v1) – Load balancing Django with Nginx & Docker.
- 📊 [**Predictive Maintenance with Data Mining**](https://github.com/hamzaaityoussef/Predictive-maintenance-with-Data-Mining)
- 🧠 [**MedAccessAI**](https://github.com/hamzaaityoussef/MedAccessAI) – AI for medical data.
